...
type CssStyle with
    ...
    static member inline translateX : ICssStyle = unbox "translateX"
    static member inline translateY  : ICssStyle = unbox "translateY"
    static member inline translateZ  : ICssStyle = unbox "translateZ"
    static member inline rotateX  : ICssStyle = unbox "rotateX"
    static member inline rotateY  : ICssStyle = unbox "rotateY"
    static member inline rotateZ  : ICssStyle = unbox "rotateZ"
    static member inline scaleX  : ICssStyle = unbox "scaleX"
    static member inline scaleY  : ICssStyle = unbox "scaleY"
    static member inline scaleZ  : ICssStyle = unbox "scaleZ"
    static member inline skew  : ICssStyle = unbox "skew"
    static member inline skewX  : ICssStyle = unbox "skewX"
    static member inline skewY  : ICssStyle = unbox "skewY"
    static member inline draw : ICssStyle = unbox "draw"
    static member inline x: ICssStyle = unbox "x"
    static member inline y: ICssStyle = unbox "y"
    static member inline z: ICssStyle = unbox "z"
